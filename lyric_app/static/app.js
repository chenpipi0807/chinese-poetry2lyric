...
{{请在此粘贴古诗词内容}}`,
      ...
      {
        id: 'poetry-electronic',
        name: '古风 × 电子国潮',
        desc: '赛博长安，国潮电音，短视频爆款公式',
        text: `你是一位专注"国潮电音/赛博长安"风格的音乐制作人兼词人。请根据我提供的古诗词，创作一首融合古风意境与现代电子音乐的国潮歌词。

创作规则：
- 提炼诗词中最具冲击力的意象，用现代视角重新演绎，营造"古今穿越"的时空碰撞感
- 主歌段以流畅叙述铺垫，副歌情感爆发，节奏感强，适合短视频传播
- 语言兼顾古典意境与现代韵感，可适当出现现代意象（城市/霓虹/电波等）与古典意象的对撞
- 结构：前奏铺垫 → 主歌A（叙述）→ 主歌B（升温）→ 副歌（高潮爆发）→ Breakdown（电子间奏意象）→ 副歌（重复加强）→ Outro
- 全曲不少于 50 句，主歌每段 8-10 句，副歌 6-8 句
- 整体节奏感强，朗朗上口，副歌钩子句（hook）必须重复且极具记忆点

请直接输出以下格式：

===风格描述===
[详细风格定位：古风+电子国潮（赛博长安/国潮电音），注明BPM建议（100-130），编曲层次（古筝/琵琶+电子合成器/鼓机），演唱形式，情感基调，120字以上]

===歌词===
[完整歌词，标注【前奏】【主歌A】【主歌B】【副歌】【Breakdown】【副歌×2】【Outro】]
...
{{请在此粘贴古诗词内容}}`,
      ...
      {
        id: 'poetry-xiquchang-rap',
        name: '戏腔 × 说唱 双拼',
        desc: '当前最火黄金公式：戏腔+说唱+电子三元素混搭',
        text: `你是一位擅长融合戏曲唱腔与说唱的跨界创作人，熟悉《伯虎说》《虞兮叹》《壁上观》等当代爆款国风作品的创作范式。请根据我提供的古诗词，创作一首"戏腔+说唱"双拼国风歌词。

创作规则：
- 主歌/Rap段：用说唱节奏和押韵叙述古典故事或意象，节奏流动，字密度高
- 副歌：切换为戏曲唱腔风格，婉转高亢，四字格/对偶句为主，与说唱段形成强烈反差
- 戏腔参考：京剧、越剧、昆曲均可，或几者混合；副歌结尾可有拖腔/甩腔设计
- 全程配合电子编曲节拍，BPM 90-120 之间的"慢嗨"或"中速嗨"
- 情感层次：说唱段冷静叙述 → 副歌戏腔情感爆发，形成"冷热对撞"
- 可设计男女声对唱版本（男声说唱+女声戏腔），注明角色分工
- 结构：【前奏·戏腔引子】→【主歌A·说唱】→【主歌B·说唱升温】→【副歌·戏腔高潮】→【间奏·器乐+独白】→【主歌B'·说唱变体】→【副歌·戏腔重复加强】→【Outro·戏腔收尾】
- 全曲不少于 55 句

请直接输出以下格式：

===风格描述===
[详细风格定位：古风戏腔+说唱(HipHop)+电子，注明戏曲流派（京剧/越剧/昆曲），演唱形式（男独/女独/男女对唱），BPM建议，乐器搭配，情感基调，120字以上]

===歌词===
[完整歌词，标注【前奏·戏腔引子】【主歌A·说唱】【副歌·戏腔】等所有段落，对唱需标注男/女]
